...
describe('map-sections', () => {
  ...
  it('should map section two columns when given an empty object', () => {
  ...
  it('should map section two columns with a filled object', () => {
    const section = {
    ...
    const data = mapSectionTwoColumns(section);
  ...
  it('should map section content when given an empty object', () => {
  ...
  it('should map section content when given a filled objec', () => {
    const data = mapSectionContent({
